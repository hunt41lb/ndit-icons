 ...
 * Auto-generated by build-icons.js — do not edit manually
 *
 * Prefix:  ndit:
 * Icons:   1
 * Built:   2026-01-31T19:51:14.040Z
 *
 * Usage in HA:
 *   icon: ndit:brand-streaming-disney-plus
 *
...
const NDIT_ICONS = {
  "brand-streaming-disney-plus": { viewBox: "-5.35 -20.13 1053.89 738.50", content: `<defs>
    <radialGradient id="brand-streaming-disney-plus-grad" cx="944.52" cy="281.8" gradientTransform="matrix(1 0 0 -1 0 563.4)" gradientUnits="userSpaceOnUse" r="760.12">
      <stop offset=".01" class="gradient-start"/>
      <stop offset=".03" class="gradient-mid" stop-opacity=".8"/>
      <stop offset=".22" class="gradient-mid"/>
      <stop offset="1" class="gradient-end" stop-opacity="0"/>
    </radialGradient>
  </defs>
  <!-- Disney+ text/logo and plus sign -->
  ...
  <!-- Gradient arc -->
  <path class="icon-gradient" d="M957.3 275.6a438.92 438.92 0 0 0-771.9-78 5.12 5.12 0 0 0-.6 4.5 4.88 4.88 0 0 0 3.2 3.2l11.4 3.9a7.47 7.47 0 0 0 2 .3 6.59 6.59 0 0 0 5.3-2.8A415.52 415.52 0 0 1 550.6 24.5a416.08 416.08 0 0 1 383.1 253.9 6 6 0 0 0 5.5 3.7h13.6a4.58 4.58 0 0 0 3.9-2.1 4.38 4.38 0 0 0 .6-4.4zm-755.9-69.5a2.92 2.92 0 0 1-.9-.2 2.92 2.92 0 0 0 .9.2zm735 74.2a4.05 4.05 0 0 0 .9.5c-.3-.2-.6-.3-.9-.5z" fill="url(#brand-streaming-disney-plus-grad)"/>` }
};
...
function getIcon(name) {
  ...
  content = content
    .replace(/class="icon-primary"/g,  'fill="var(--ndit-icon-primary, #ffffff)"')
    .replace(/class="icon-gradient"/g, 'fill="url(#' + name + '-grad)"')
    .replace(/class="gradient-start"/g, 'stop-color="var(--ndit-gradient-start, #ffffff)"')
    .replace(/class="gradient-mid"/g,   'stop-color="var(--ndit-gradient-mid, #00ffff)"')
    .replace(/class="gradient-end"/g,   'stop-color="var(--ndit-gradient-end, #0000ff)"');
...
window.customIconsets["ndit"] = getIcon;

console.info(
  "%c NDIT Icons %c loaded 1 icon(s) ",
